...
Methods: There are two methods which receive the burst time array as a parameter and calculate the average wait and turn around times respectively.
...
The creation of process object was ideal in this scenario due to the processes needing to be sorted by arrival time and in worst case, priority. 
